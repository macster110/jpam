...
public class AnimalSpotTest {
	...
	public static void main( String[] args ) {
		...
		runAnimalSpot(modelPath,  wavPath, samplesChunk); 

	}

	public static double[] runAnimalSpot(AnimalSpotModel soundSpotModel, AudioData soundData, int[] samplesChunk, int nRuns, boolean verbose) {
		...
		try {			
			...
			String transformsString = soundSpotModel.getTransformsString();
					
			
			AnimalSpotParams dlParams = new AnimalSpotParams(transformsString);
	...
	public static double[] runAnimalSpot(String modelPath, String wavFilePath, int[] samplesChunk) {
		...
		try {			
			...
			return runAnimalSpot( soundSpotModel,  soundData, samplesChunk, 10,  false) ;
