package org.jamdev.jpamutilsfx.utilsfx;
...
/**
 * Load SVG icons. These are preferable to images because they scale nicely
 * between different resolution displays. code adapted from
 * https://github.com/DeskChan/DeskChan
 * 
 * @author Jamie Macaulauy
 *
 */
public class PamSVGIcon {
    ...
    public static PamSVGIcon create(File path) throws Exception {
        ...
        for(int i=0; i<svgPaths.getLength(); i++) {
            try {
                ...
                if(map.getNamedItem("style") != null) {
                    ...
                    shape.setStyle("-fx-fill: black; -fx-stroke-width: 2;");
                }
                shapes.add(shape);
            } catch (Exception e) {
               e.printStackTrace();
